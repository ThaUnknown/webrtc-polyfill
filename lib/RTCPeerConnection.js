...
export default class RTCPeerConnection extends EventTarget {
  ...
  constructor (init = {}) {
    ...
    this.#peerConnection = new NodeDataChannel.PeerConnection(this.#config.peerIdentity || `peer-${getRandomString(7)}`, {
  ...
  /** @type {globalThis.RTCPeerConnection['addTrack']} */
  ...
  /** @type {globalThis.RTCPeerConnection['createDataChannel']} */
  ...
  /** @type {globalThis.RTCPeerConnection['setConfiguration']} */
